...
export function MaterialSymbolsEventListOutline(
...
export function TdesignMember(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function IonTrophyOutline(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function MaterialSymbolsCalendarMonthOutline(
  props: SVGProps<SVGSVGElement>,
) {
  return (
    <svg
