  ...
  return (
    <>
      ...
      <div className='container-layout'>
        ...
        >
          We Are <span className='text-primaryNormal'>EISD Laboratory</span>
        </HeadingBanner>
      </div>
      ...
      <div className='container-layout max-w-[1216px]'>
        <div
          ...
          style={{
            backgroundImage: 'url(./FotoEISD.jpg)',
        ...
        <SectionHeading.ParagraphBottom className='text-justify'>
          At the Enterprise Intelligence System Development (EISD) Laboratory, we are driven
